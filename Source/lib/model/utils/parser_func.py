...
def set_dataset_args(args, test=False):
    if not test:
        if args.dataset == "hos":
            ...
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "voc_medical_trainval":
            args.imdb_name = "voc_2007_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "voc_medical_train":
            args.imdb_name = "voc_2007_train"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
        elif args.dataset == "voc_12":
        ...
        elif args.dataset_t == "voc_medical":
            args.imdb_name_target = "voc_2007_test"
